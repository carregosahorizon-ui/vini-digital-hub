      ...
      <div className="container max-w-6xl mx-auto">
        ...
        duration: 0.8
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Tenha acesso à minha equipe completa de tráfego pago, preparada para anunciar sua empresa com o método Axion Pro. Agende um
