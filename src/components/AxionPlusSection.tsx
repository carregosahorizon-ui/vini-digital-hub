      ...
      <div className="container max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">Axion Plus</h2>
            
            <p className="text-lg text-muted-foreground leading-relaxed">
              Com o Axion Plus, você terá acesso ao meu serviço exclusivo para acelerar resultados no digital com estratégias validadas. Preencha o formulário e dê o próximo passo para transformar o seu negócio.
            </p>
          ...
          >
            ...
            <img 
              src={viniAvatar} 
              alt="Vini - Consultor Digital" 
              className="relative z-10 w-full h-auto rounded-3xl shadow-2xl border-2 border-primary/20" 
            />
